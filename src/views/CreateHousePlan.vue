<template>
  <div>
    ...
    <div id="panel" class="leftBox">
      <ul class="list-unstyled">
        <li><button class="btn disabled halfy " id="undo" title="undo"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i></button>
        ...
        <li><button class="btn btn-default halfy " id="report_mode" title="Show report"><i class="fa fa-calculator" aria-hidden="true"></i></button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-3 col-xs-3 boxMouseOver" style="min-height:140px;margin:15px;background:url('../ressources/newPlanEmpty.jpg')"><img src="../ressources/newPlanEmpty.jpg" class="img-responsive" onclick="initHistory();$('#myModal').modal('toggle')"/></div>
              <div class="col-md-3 col-xs-3 boxMouseOver"  style="min-height:140px;margin:15px;background:url('../ressources/newPlanEmpty.jpg')"><img src="../ressources/newPlanSquare.jpg"  class="img-responsive" style="margin-top:10px" onclick="initHistory('newSquare');$('#myModal').modal('toggle')"/></div>
              <div class="col-md-3 col-xs-3 boxMouseOver"  style="min-height:140px;margin:15px;background:url('../ressources/newPlanEmpty.jpg')"><img src="../ressources/newPlanL.jpg"  class="img-responsive" style="margin-top:20px" onclick="initHistory('newL');$('#myModal').modal('toggle')"/></div>
            </div>
          </div>
        </div>
      </div>
...
<script>
  export default {
    ...
    async mounted() {
      await import("../ressources/jquery.min.js")
      await import("../ressources/bootstrap.min.js")
      await import("../ressources/func")
    },
    methods: {
      quitCreateHouse(){
        console.log('quit')
